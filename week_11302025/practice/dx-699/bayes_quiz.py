"""
Interactive Bayes' Rule, Naïve Bayes, and Evidence Lift Quiz
...
def load_quiz(filename="bayes_quiz.json"):
...
def take_quiz():
    ...
    quiz_data = load_quiz("bayes_quiz.json")
    ...
    for i, q in enumerate(questions, 1):
        ...
        if 'formula_used' in q:
            print(f"Formula: {q['formula_used']}\n")
    ...
    if percentage >= 90:
        ...
        print("\n📖 Review the material and try again. Pay special attention to the formula applications.")
